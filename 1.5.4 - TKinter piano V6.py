...
'''Version 6 adds frequencies instead of prerecorded sounds. It honestly sounds worse and I cant get sounds to play before another is finished.'''
import time
import winsound
from tkinter import *
########
...
root = Tk()
root.title("Piano")
root.geometry("1000x500+400+125")
root.config(bg = "pink")
root2 = Tk()
root2.title("Songs")
root2.geometry("300x500+100+125")
...
def C(event=0):
    ...
    winsound.Beep(261,500|winsound.SND_ASYNC)
    if recordIt:
...
def D(event=0):
    ...
    winsound.Beep(294,500|winsound.SND_ASYNC)
    if recordIt:
...
def E(event=0):
    ...
    winsound.Beep(329,500|winsound.SND_ASYNC)
    if recordIt:
...
def F(event=0):
    ...
    winsound.Beep(349,500|winsound.SND_ASYNC)
    if recordIt:
...
def G(event=0):
    ...
    winsound.Beep(391,500|winsound.SND_ASYNC)
    if recordIt:
...
def A(event=0):
    ...
    winsound.Beep(440,500|winsound.SND_ASYNC)
    if recordIt:
...
def B(event=0):
    ...
    winsound.Beep(493,500|winsound.SND_ASYNC)
    if recordIt:
...
def C2(event=0):
    ...
    winsound.Beep(523,500|winsound.SND_ASYNC)
    if recordIt:
...
def CSharp(event=0):
    ...
    winsound.Beep(277,500|winsound.SND_ASYNC)
    if recordIt:
...
def DSharp(event=0):
    ...
    winsound.Beep(311,500|winsound.SND_ASYNC)
    if recordIt:
...
def FSharp(event=0):
    ...
    winsound.Beep(369,500|winsound.SND_ASYNC)
    if recordIt:
...
def GSharp(event=0):
    ...
    winsound.Beep(415,500|winsound.SND_ASYNC)
    if recordIt:
...
def ASharp(event=0):
    ...
    winsound.Beep(466,500|winsound.SND_ASYNC)
    if recordIt:
